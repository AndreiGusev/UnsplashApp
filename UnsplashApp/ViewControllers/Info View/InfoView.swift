...
class InfoView: UIView {
    ...
    var unsplashPhoto: UnsplashPicturesModel?
    ...
    private let infoLabels: [UILabel] = {
        var labels: [UILabel] = []
        for parameter in PictureInfo.allCases {
    ...
    func updateInfoView(unsplashPhoto: UnsplashPicturesModel){
    ...
    //  For huge descriptions, because sometimes in description field containe very long string
